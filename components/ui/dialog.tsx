    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "gap-4 rounded-xl border p-6 shadow-lg duration-200 sm:max-w-lg",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          ...
          >
            <span className="bg-blue-50 p-2 rounded-full inline-flex items-center justify-center cursor-pointer">
